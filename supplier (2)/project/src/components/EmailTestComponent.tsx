    ...
    <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-lg">
      ...
      <div className="p-4 bg-yellow-50 rounded-lg border-l-4 border-yellow-400">
        ...
        <div className="text-yellow-700 text-sm space-y-2">
          ...
          <ol className="list-decimal list-inside ml-4 space-y-1">
            <li>Créé un compte EmailJS sur <a href="https://www.emailjs.com/" target="_blank" rel="noopener noreferrer" className="underline">emailjs.com</a></li>
            <li>Configuré un service email (Gmail, Outlook, etc.)</li>
            <li>Créé un template email pour les notifications fournisseur</li>
            <li>Créé un fichier <code className="bg-yellow-200 px-1 rounded">.env</code> avec vos identifiants EmailJS</li>
            <li>Redémarré le serveur de développement après avoir ajouté les variables d'environnement</li>
          </ol>
          <p className="mt-3">
      ...
      <div className="mt-6 p-4 bg-blue-50 rounded-lg">
        ...
        <div className="bg-blue-800 text-blue-100 p-4 rounded font-mono text-sm overflow-x-auto">
          <div>VITE_EMAILJS_SERVICE_ID = {import.meta.env.VITE_EMAILJS_SERVICE_ID || 'NON DÉFINI'}</div>
          <div>VITE_EMAILJS_SUPPLIER_ORDER_TEMPLATE_ID = {import.meta.env.VITE_EMAILJS_SUPPLIER_ORDER_TEMPLATE_ID || 'NON DÉFINI'}</div>
          <div>VITE_EMAILJS_PUBLIC_KEY = {import.meta.env.VITE_EMAILJS_PUBLIC_KEY || 'NON DÉFINI'}</div>
        </div>
